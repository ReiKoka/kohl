...
function FilledCart() {
  ...
  return (
    <div className="flex h-full flex-col overflow-hidden">
      ...
      <div className="mt-3 lg:mx-4 lg:my-3 lg:flex lg:h-full lg:gap-4">
        ...
        <div className="bg-base-200 shadow-custom absolute bottom-0 left-0 z-10 grid w-full grid-cols-2 flex-col gap-2 rounded-t-2xl p-4 lg:static lg:bottom-auto lg:left-auto lg:h-full lg:flex-1/3 lg:grid-rows-[auto_auto_1fr] lg:rounded-2xl 2xl:flex-1/4">
          ...
          {/* ================================================= Clear Cart Button ================================================= */}
          <button
            className="btn btn-outline font-primary flex items-center justify-center gap-4 text-base transition-all duration-150 active:scale-90 lg:col-start-1 lg:col-end-3 xl:col-start-2 xl:col-end-3"
          ...
          {/* ================================================= Checkout Button ================================================= */}
          <button
            className="btn btn-primary font-primary flex items-center justify-center gap-4 text-base transition-all duration-150 active:scale-90 lg:hidden"
          ...
          <div className="divider col-start-1 col-end-3 hidden lg:mb-2 lg:flex">
            OR
          </div>
